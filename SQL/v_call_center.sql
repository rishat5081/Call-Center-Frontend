...
--
-- Host: localhost:3306
-- Generation Time: Sep 24, 2020 at 07:29 AM
...
--
-- Table structure for table `call_center_campaign_info`
--

CREATE TABLE `call_center_campaign_info` (
...
--
-- Dumping data for table `call_center_campaign_info`
--

INSERT INTO `call_center_campaign_info` (`campaign_id`, `campaign_name`, `campaign_country`, `campaign_start_Date`, `campaign_type`, `call_cent_id`) VALUES
(1, 'Homeland Security ', 'USA', '25-01-2016', 'Sale', 1);
...
INSERT INTO `call_center_employees` (`emp_id`, `emp_fullName`, `emp_username`, `emp_email`, `emp_password`, `emp_role`, `emp_timing`, `emp_salary`, `emp_commission`, `call_cent_id`, `emp_target`, `campaign_id`) VALUES
(1, 'Affan Ahmed', 'affan123', 'affan@gamail.com', 'saad1234', 'CSR', 'Evening', '1500', '5', 1, 15, 1);
...
INSERT INTO `call_center_info` (`call_cent_id`, `call_cent_Name`, `no_Of_Seat`, `inbound_outbound`, `callback_dialing`, `numberOf_Callback`, `user_id`) VALUES
(1, 'ITZ Solutions', 5, 'In Bound', 1, 5, 1);
...
INSERT INTO `call_cent_user_info` (`user_id`, `user_full_name`, `user_username`, `user_email`, `user_password`, `user_first_login`, `user_contact_Number`, `admin_id`) VALUES
(1, 'Saad Sohail', 'saad11', 'binfarooq@gmail.com', '$2b$10$WtY9J31csWufr0.eyd2iHe58pPqveVnwQ5FNusY/ERaWIiePzWgUu', 0, '0345-5536125', 1);
...
--
-- Indexes for table `call_center_campaign_info`
--
ALTER TABLE `call_center_campaign_info`
...
ALTER TABLE `call_center_employees`
  ...
  ADD KEY `IXFK_call_center_employees_call_center_campaign_info` (`campaign_id`),
...
--
-- AUTO_INCREMENT for table `call_center_campaign_info`
--
ALTER TABLE `call_center_campaign_info`
...
--
-- Constraints for table `call_center_campaign_info`
--
ALTER TABLE `call_center_campaign_info`
...
--
ALTER TABLE `call_center_employees`
  ADD CONSTRAINT `FK_call_center_employees_call_center_campaign_info` FOREIGN KEY (`campaign_id`) REFERENCES `call_center_campaign_info` (`campaign_id`),
...
--
ALTER TABLE `call_center_sales`
  ADD CONSTRAINT `FK_call_center_sales_call_center_campaign_info` FOREIGN KEY (`campaign_id`) REFERENCES `call_center_campaign_info` (`campaign_id`),
